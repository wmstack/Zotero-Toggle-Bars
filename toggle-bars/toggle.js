Toggles = {
    ...
    addMenuItems(window) {
		...
		// tab_bar_item.setAttribute('type', 'checkbox');
		tab_bar_item.setAttribute('data-l10n-id', 'toggle-tab');
		tab_bar_item.addEventListener('command', () => {
			log(tab_bar_item.checked + "is weird")
			Toggles.toggleTabBar(doc, tab_bar_item.checked);
		});
